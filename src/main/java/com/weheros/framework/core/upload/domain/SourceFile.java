...
public class SourceFile {
	...
	public String getBig() {
		return completeUrl(this.big);
	}
	public String getThumb() {
		return completeUrl(this.thumb);
	}
	public String getOrigin() {
		return completeUrl(this.origin);
	}
	...
	public String getMedium() {
		return completeUrl(this.medium);
	}
	
	//concuplate the http url of image's address	
	private String completeUrl(final String url) {
			FastDFSConfigure fdfs = ApplicationConfigureFactory
					.takeConfigure(FastDFSConfigure.class);
			return "http://"+fdfs.takeTrackerIp()+":"+fdfs.getTracker_http_port()+"/"+url;
	}
